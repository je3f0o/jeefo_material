 jeefo.register("./states/main.sensors_state.js", async (exports, module) => { const __dirname = "./states", __filename = "./states/main.sensors_state.js"; const require = path => { return jeefo.require(path, __filename, __dirname); }; /* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
* File Name   : main.sensors_state.js
...
const template = (`<md-card variant="outlined"><md-toolbar color="primary">Sensor API Feature detection</md-toolbar><div class="md-background"><md-list><md-list-item for-each="f in features"><label>{{ f.name }}</label><md-list-meta><md-checkbox value="f.is_supported" is-disabled="true"></md-checkbox></md-list-meta></md-list-item></md-list></div></md-card><md-card variant="outlined" style="margin-top: 16px; user-select: none;"><md-toolbar color="primary">Gyroscope senser 3D</md-toolbar><div class="aspect-ratio-16-9"><canvas></canvas></div></md-card>`
/* space filler
...
//# sourceURL=./states/main.sensors_state.js 