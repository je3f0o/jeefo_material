 jeefo.register("node_modules/@jeefo/component/compiler.js", async (exports, module) => { const __dirname = "node_modules/@jeefo/component", __filename = "node_modules/@jeefo/component/compiler.js"; const require = path => { return jeefo.require(path, __filename, __dirname); }; /* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
...
const definitions_table   = (await require("./definitions_table"));
const TextBinder          = (await require("./text_binder"));
const Directive           = (await require("./components/directive"));
const StructureComponent  = (await require("./components/structure_component"));
const RenderableComponent = (await require("./components/renderable_component"));
...
//# sourceURL=node_modules/@jeefo/component/compiler.js 