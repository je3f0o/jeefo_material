 jeefo.register("node_modules/@jeefo/state/components/ui_view.js", async (exports, module) => { const __dirname = "node_modules/@jeefo/state/components", __filename = "node_modules/@jeefo/state/components/ui_view.js"; const require = path => { return jeefo.require(path, __filename, __dirname); }; /* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
...
const router    = (await require("../index"));
const {compile} = (await require("@jeefo/component"));
...
exports.style = (`ui-view{width:100%;height:100%;display:block}`
/* space filler
...
exports.controller = (function () { function UIView () {} 
    UIView.prototype.on_init = async function ($element, component) {
    ...
    UIView.prototype.on_destroy = function () {
        router.off("create_ui" , this.on_create_ui);
        router.off("destroy_ui", this.on_destroy_ui);
        router.off("replace_ui", this.on_replace_ui);
    };
UIView.__jeefo_class__ = true; return UIView;}());
 }); 
//# sourceURL=node_modules/@jeefo/state/components/ui_view.js 