 jeefo.register("node_modules/@jeefo/state/jeefo_state.js", async (exports, module) => { const __dirname = "node_modules/@jeefo/state", __filename = "node_modules/@jeefo/state/jeefo_state.js"; const require = path => { return jeefo.require(path, __filename, __dirname); }; /* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
...
const jeefo_template = (await require("@jeefo/template"));
const PathFinder     = (await require("./path_finder"));

const assign_error = property => {
    throw new Error(`${ property } property is assignable only once`);
};

var JeefoState = (function () { 
    function JeefoState (options) {
        this.query  = {};
        this.params = {};
...
JeefoState.__jeefo_class__ = true; return JeefoState;}());

module.exports = JeefoState;
 }); 
//# sourceURL=node_modules/@jeefo/state/jeefo_state.js 