 jeefo.register("node_modules/@jeefo/material/utils/theme.js", async (exports, module) => { const __dirname = "node_modules/@jeefo/material/utils", __filename = "node_modules/@jeefo/material/utils/theme.js"; const require = path => { return jeefo.require(path, __filename, __dirname); }; /* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
* File Name   : theme.js
...
const functions = (await require("./functions"));
...
var MDThemeSheet = (function () { 
    function MDThemeSheet () {
        this.rules = Object.create(null);
    }

    MDThemeSheet.prototype.add = function (theme, sheet) {
...
MDThemeSheet.__jeefo_class__ = true; return MDThemeSheet;}());

var MDTheme = (function () { 
    function MDTheme (name, colors, rules, sheet) {
        this.name          = name;
    ...
    MDTheme.prototype.eval_rules = function (sheet) {
        for (let [selector, block] of Object.entries(sheet)) {
            const css_rules = [];
            for (let [prop, value] of Object.entries(block)) {
                const matches = value.match(FN_REGEX);
    ...
    MDTheme.prototype.eval_sheet = function (sheet) {
        for (let [selector, block] of Object.entries(sheet)) {
            const rules = {};
            for (let [prop, value] of Object.entries(block)) {
                const matches = value.match(FN_REGEX);
    ...
    MDTheme.prototype.get_color = function (value) {
    ...
    MDTheme.prototype.eval = function (var_name) {
    ...
    MDTheme.prototype.get_rules = function (selector) {
        return this.sheet.rules[selector] || this.default_sheet.rules[selector];
    };

    MDTheme.prototype.eval_css_rules = function (css_rules) {
...
//# sourceURL=node_modules/@jeefo/material/utils/theme.js 