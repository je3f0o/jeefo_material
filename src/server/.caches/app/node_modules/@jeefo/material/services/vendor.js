 jeefo.register("node_modules/@jeefo/material/services/vendor.js", async (exports, module) => { const __dirname = "node_modules/@jeefo/material/services", __filename = "node_modules/@jeefo/material/services/vendor.js"; const require = path => { return jeefo.require(path, __filename, __dirname); }; /* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
* File Name   : vendor.js
...
const dash_case  = (await require("@jeefo/utils/string/dash_case"));
...
var MDVendorService = (function () { function MDVendorService () {} 
    //constructor () { }

    MDVendorService.prototype.has_support = function (property) {
    ...
    MDVendorService.prototype.property = function (property) {
    ...
    MDVendorService.prototype.prefix = function (property, value) {
        if (this.has_support(property)) {
            return `${ supported_props[property] } : ${ value };`;
        }
        return '';
    };
MDVendorService.__jeefo_class__ = true; return MDVendorService;}());

module.exports = new MDVendorService();
 }); 
//# sourceURL=node_modules/@jeefo/material/services/vendor.js 