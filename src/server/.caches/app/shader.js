 jeefo.register("./shader.js", async (exports, module) => { const __dirname = ".", __filename = "./shader.js"; const require = path => { return jeefo.require(path, __filename, __dirname); }; /* -.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.
* File Name   : shader.js
...
var JeefoShader = (function () { 
    function JeefoShader (canvas, {source = default_fs_src} = {}) {
    ...
    JeefoShader.prototype.play = function () {
        this.raf_id = requestAnimationFrame(this.main_loop);
    };

    JeefoShader.prototype.destroy = function () {
...
JeefoShader.__jeefo_class__ = true; return JeefoShader;}());
